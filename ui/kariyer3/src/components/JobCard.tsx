      ...
      <div className="surface rounded-2xl p-6 md:p-7 border border-white/10 hover:border-teal-400/50 transition-smooth hover:-translate-y-0.5">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-2">
            <h3 className="text-2xl md:text-3xl font-black tracking-tight text-main group-hover:text-teal-500 transition-smooth">
              {job.title}
            </h3>
            <p className="text-lg font-semibold text-muted">{job.company}</p>
          </div>
