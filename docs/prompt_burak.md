...
* **Storage:** `@hackathon\docs\WALRUS_STORE.md` (CV blob depolama)
* **Auth:** `@hackathon\docs\ZKLOGIN.md` (Google/Twitch Login)
* **Privacy:** `@hackathon\docs\SEAL_PRIVACY.md` (Gizli Başvuru Mimarisi)
